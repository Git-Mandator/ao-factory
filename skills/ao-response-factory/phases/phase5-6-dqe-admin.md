...
|---|---|---|
| KBIS ou extrait Sirene (< 3 mois) | À vérifier | `20_AO_FACTORY/knowledge/annexes-types/administratif/` |
...
| Certificat de bonne exécution (références) | À vérifier | `20_AO_FACTORY/knowledge/annexes-types/administratif/` |
